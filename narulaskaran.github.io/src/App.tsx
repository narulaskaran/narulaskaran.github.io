    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <header className="text-center mb-12">
          <Avatar className="w-32 h-32 mx-auto mb-4 transform hover:scale-104 hover:shadow-lg hover:shadow-[rgba(128,0,0,0.1)]">
            <AvatarImage
          ...
          <div className="flex justify-center space-x-4">
            <a
              ...
              className="text-[rgba(128,0,0,0.9)] hover:text-[rgba(128,0,0,1)]"
            >
              <svg
        ...
        <section>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {projects.map((project, index) => (
              <Card
                key={index}
                className="overflow-hidden cursor-pointer transition-all duration-300 transform hover:scale-101 hover:shadow-lg hover:shadow-[rgba(128,0,0,0.1)]"
